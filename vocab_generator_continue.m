function [sequences,final_sequence,costs,sequence_matrix] = vocab_generator_continue(sequence_matrix,w_p,w_s,num_species,num_flies,mutate_prob,max_iter,seq_length)
%% Runs the naming game from specified sequence matrix
% Inputs:
% sequence_matrix: num_flies x seq_length x num_species matrix of flash
%   sequences
...
scores = NaN*zeros(num_flies*num_species,100000); % similarity scores

% save to memory every 100 steps

timesaves = 100:100:1000;
